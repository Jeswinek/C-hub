...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Padding(
          child: Container(
            child: _button('LOGIN', Colors.lightGreen, Colors.white,
        ...
        Padding(
          child: Container(
            child: _button('Create New', Colors.transparent, Colors.green,
                Colors.green, 5.0,),
            width: MediaQuery.of(context).size.width,
            height: 65,
          ),
  ...
  Widget _button(String text, Color fillColor, Color textColor,
